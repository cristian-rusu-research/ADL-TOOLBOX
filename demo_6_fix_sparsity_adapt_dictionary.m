...
params.K = 10;
params.K_MIN = 10;  %%% these two lines make sure that the dictionary stars from 10 atoms
params.K_MAX = 4*size(params.Y, 1);
...
params.func_statistics = @frobenius_norm_squared_dictionary_size;
