...
params.func_dictionary_update = @ksvd_batch;    %%% dictionary update step
params.func_sparse_approximation = @orthogonal_matching_pursuit_slow;   %%% sparse approximation step
params.FIG_DICT_TEXT = 'k-svd alg';
